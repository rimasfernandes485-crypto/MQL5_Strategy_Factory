...
#property strict
#property description "Ativo: XAUUSD; tempo gráfico: 1 hora; indicador: Bandas de Bollinger de 20 períodos e desvio-padrão 2.000.
Estratégia: Quando o preço atingir a banda inferior das bandas de bollinger entrar comprando um microlote (0.01), com o objetivo de 5000 pontos (para um microlote, é $ 50.00). Se o preço continuar caindo e ficar 5000 pontos negativos, entrar comprando DOIS microlotes, objetivando um ganho de 5000 pontos (para 0.02, dará $ 100.00). E se o mercado continuar caindo ainda assim, quando estiver 100000 (cem mil pontos) negativos em relação à entrada inicial, entrar comprando QUATRO microlotes (0.04), objetivando 100000 pontos (neste caso, $400.00), pois desta forma recuperará os outros prejuízos. 
Se os dois lotes atingirem o objetivo, uma nova ordem é colocada nos 5000 pontos negativos em relação à primeira entrada, para o caso de o mercado cair novamente. O mesmo vale para os quatro microlotes.
O stop da operação é zerar todos os lotes quando estiver 150000 pontos negativos em relação à primeira entrada. Ai zerarão todas as entradas ativas deste estratégia."
#property description "Timeframe: H1 | Asset: XAUUSD"
...
void OpenPosition(ENUM_ORDER_TYPE orderType)
{
   ...
   request.deviation = 10;
   request.magic = MagicNumber;
   request.comment = "Base44_XAUUSD_Bollinger";
